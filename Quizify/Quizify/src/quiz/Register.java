...
public class Register extends JFrame
{
	...
	{	
		...
		btnSignup.addActionListener(new ActionListener() 
				...
				if (user_name.equals("") || passwd.equals("") || full_name.equals("") || g_mail.equals("") )
				{
					JOptionPane.showMessageDialog(null,"Please Enter Above Information","Error",JOptionPane.ERROR_MESSAGE);
				}
				else  
                                {
